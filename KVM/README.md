...
This document provides a comprehensive analysis of execution latencies, determinism, and real-time capabilities within a virtualized environment based on the KVM hypervisor. It evaluates system behavior across various host-guest kernel configurations, ranging from standard non-real-time environments to fully optimized end-to-end `PREEMPT_RT` stacks.

## Contents

* [Baseline Performance Analysis](#baseline-performance-analysis-in-kvm-environments)
  * [Non-Real-Time Host and Non-Real-Time Guest](#non-real-time-host-and-non-real-time-guest)
  * [Non-Real-Time Host and Real-Time Guest](#non-real-time-host-and-real-time-guest)
  * [Real-Time Host and Non-Real-Time Guest](#real-time-host-and-non-real-time-guest)
  * [Real-Time Host and Real-Time Guest](#real-time-host-and-real-time-guest-full-rt-stack)
* [Impact of the Stress Workload](#impact-of-the-stress-workload-on-latencies)
  * [Non-Real-Time Host and Non-Real-Time Guest](#non-real-time-host-and-non-real-time-guest--stress-host)
  * [Non-Real-Time Host and Real-Time Guest](#non-real-time-host-and-real-time-guest--stress-host)
  * [Real-Time Host and Non-Real-Time Guest](#real-time-host-and-non-real-time-guest--stress-host)
  * [Real-Time Host and Real-Time Guest](#real-time-host-and-real-time-guest--stress-host)
* [Isolated Stress Host Performance Analysis](#isolated-stress-host-performance-analysis)
  * [Non-Real-Time Host and Non-Real-Time Guest](#non-real-time-host-and-non-real-time-guest-isolated-stress-host)
  * [Non-Real-Time Host and Real-Time Guest](#non-real-time-host-and-real-time-guest-isolated-stress-host)
  * [Real-Time Host and Non-Real-Time Guest](#real-time-host-and-non-real-time-guest-isolated-stress-host)
  * [Real-Time Host and Real-Time Guest](#real-time-host-and-real-time-guest-full-rt-stack---isolated-stress-host)
