...
/* Worker Thread executing huff_enc */
void *huff_enc_thread(void *param) {
...
void print_histogram_to_file() {
    ...
    fprintf(fp, "# Histogram of huff_enc execution times\n");
...
void print_usage() {
    printf("huff_enc benchmark - cyclictest style runner\n");
    printf("Options:\n");
...
int main(int argc, char **argv) {
    ...
    pthread_t thread;
    if (pthread_create(&thread, NULL, huff_enc_thread, NULL) != 0) {
